...
urlpatterns = [
    ...
    path('control/delete_delivery_order/<pk>/', views.delete_delivery_order, name='delete_delivery_order'),
    path('control/show_delivery_order/<pk>/', views.show_delivery_order, name='show_delivery_order'),
